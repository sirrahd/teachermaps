...
$(document).ready(function(){
  $('#feedback_form')
    ...
    .bind("ajax:success", function(evt, data, status, xhr){
      ...
      $feedbackDropdown.append("<p id='confirm'>Thank you!</p>");
      setTimeout(function(){
...
$(document).ready(function(){
    ...
    $(document).on("click", '#map_standards_resources_table .map_objectives_resource_selected', function(e) {
    ...
    $(document).on("click", '#map_standards_resources_table .map_objectives_resource_default', function(e) {
...
$(document).ready(function(){    
    ...
    .on("ajax:success", "#create_resource_link_form", function(event, response, status, xhr) {
        ...
        pushFlash({message:"Resource upload was successful!", state: 'success', fadeOut: 5000});
        // Hide all modals
        $('.modal.in').modal('hide');   
        // Rest form
        $(this)[0].reset();
    ...
    .on("ajax:success", "#edit_resource_link_form", function(event, data, status, xhr) {
        ...
        $("#resources_table").html(data);  
        // Flash user of the success
        pushFlash({message:"Saved Changes", state: 'success', fadeOut: 5000});
        $("#uploadResourcesErrors").html('');  
        closeModalOnSubmit();
    });
...
$(document).ready(function() {
  ...
  $("#update_setting_form")
    ...
    .bind("ajax:error", function(event, data, status, xhr) {
        // Flash user of the error
        pushFlash("Error in saving settings", 'error');  
    })
    .bind("ajax:success", function(event, data, status, xhr) {
        // Flash user of the success
        pushFlash({message:"Settings saved", state:'success', fadeOut:4000});
    });
...
var I18n = I18n || {};
I18n.translations = {"en":{"date":{"formats":{"default":"%Y-%m-%d","short":"%b %d","long":"%B %d, %Y"},"day_names":["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"abbr_day_names":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"month_names":[null,"January","February","March","April","May","June","July","August","September","October","November","December"],"abbr_month_names":[null,"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"order":["year","month","day"]},"time":{"formats":{"default":"%a, %d %b %Y %H:%M:%S %z","short":"%d %b %H:%M","long":"%B %d, %Y %H:%M"},"am":"am","pm":"pm"},"support":{"array":{"words_connector":", ","two_words_connector":" and ","last_word_connector":", and "}},"errors":{"format":"%{attribute} %{message}","messages":{"inclusion":"is not included in the list","exclusion":"is reserved","invalid":"is invalid","confirmation":"doesn't match confirmation","accepted":"must be accepted","empty":"can't be empty","blank":"can't be blank","too_long":"is too long (maximum is %{count} characters)","too_short":"is too short (minimum is %{count} characters)","wrong_length":"is the wrong length (should be %{count} characters)","not_a_number":"is not a number","not_an_integer":"must be an integer","greater_than":"must be greater than %{count}","greater_than_or_equal_to":"must be greater than or equal to %{count}","equal_to":"must be equal to %{count}","less_than":"must be less than %{count}","less_than_or_equal_to":"must be less than or equal to %{count}","odd":"must be odd","even":"must be even"}},"activerecord":{"errors":{"messages":{"taken":"has already been taken","record_invalid":"Validation failed: %{errors}"}},"attributes":{"user":{"password_digest":"Password"}}},"number":{"format":{"separator":".","delimiter":",","precision":3,"significant":false,"strip_insignificant_zeros":false},"currency":{"format":{"format":"%u%n","unit":"$","separator":".","delimiter":",","precision":2,"significant":false,"strip_insignificant_zeros":false}},"percentage":{"format":{"delimiter":""}},"precision":{"format":{"delimiter":""}},"human":{"format":{"delimiter":"","precision":3,"significant":true,"strip_insignificant_zeros":true},"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}},"decimal_units":{"format":"%n %u","units":{"unit":"","thousand":"Thousand","million":"Million","billion":"Billion","trillion":"Trillion","quadrillion":"Quadrillion"}}}},"datetime":{"distance_in_words":{"half_a_minute":"half a minute","less_than_x_seconds":{"one":"less than 1 second","other":"less than %{count} seconds"},"x_seconds":{"one":"1 second","other":"%{count} seconds"},"less_than_x_minutes":{"one":"less than a minute","other":"less than %{count} minutes"},"x_minutes":{"one":"1 minute","other":"%{count} minutes"},"about_x_hours":{"one":"about 1 hour","other":"about %{count} hours"},"x_days":{"one":"1 day","other":"%{count} days"},"about_x_months":{"one":"about 1 month","other":"about %{count} months"},"x_months":{"one":"1 month","other":"%{count} months"},"about_x_years":{"one":"about 1 year","other":"about %{count} years"},"over_x_years":{"one":"over 1 year","other":"over %{count} years"},"almost_x_years":{"one":"almost 1 year","other":"almost %{count} years"}},"prompts":{"year":"Year","month":"Month","day":"Day","hour":"Hour","minute":"Minute","second":"Seconds"}},"helpers":{"select":{"prompt":"Please select"},"submit":{"create":"Create %{model}","update":"Update %{model}","submit":"Save %{model}"},"button":{"create":"Create %{model}","update":"Update %{model}","submit":"Save %{model}"}},"global":{"app_name":"TeacherMaps","copyright":"Copyright 2013"},"shared":{"errors":"The form contains %{count}.","error_noun":"error","save":"Save","cancel":"Cancel","create":"Create","search":"Search","action":"Action","view":"View","edit":"Edit"},"home":{"title":"Welcome to %{app_name}","link":"Home","text":"We make lesson planning easy."},"help":{"title":"Help","link":"Help","text":"Something helpful should go here."},"about":{"title":"About","link":"About","text":"Learn about us here."},"contact":{"title":"Contact","link":"Contact","text":"Contact information goes here."},"news":{"link":"News"},"signin":{"title":"Sign in","link":"Sign in","name_label":"Username or Email","password_label":"Password","error":"We couldn't find anyone with that name and password.","profile":"Profile","settings":"Settings","signout":"Sign out"},"signup":{"title":"Sign up","link":"Sign up","name_label":"Name","email_label":"Email","pwd_label":"Password","pwdconf_label":"One more time...","account_name_label":"Username","button":"Create my account!","welcome":"Welcome to %{app_name}"},"privacy":{"link":"Privacy"},"terms":{"link":"Terms"},"feedback":{"link":"Send feedback","title":"Help make us better!","text":"Your feedback is always anonymous.","button":"Send","submit":"Sending...","generic_error":"Please reload the page and try again","success":"Thank you!"},"settings":{"upload_to":"Default Upload To:","save_success":"Settings saved","save_error":"Error in saving settings","select_storage_service":"In order to upload a resource, you must select a storage service."},"resources":{"link":"Resources","web_link":"Link","synced_n_files":"Synced %{sync_count} files.","sync":"Sync","upload":"Upload","delete":"Delete","title":"Title","deleted_file":"Deleted %{title}","delete_file_confirmation":"Delete %{title}?","resource_link_error":"There was an error opening \"%{title}\"","loading":"Loading...","form_upload":"Upload a Resource","upload_success":"Resource upload was successful!","does_not_exist":"Resouce does not exist","title_blank_error":"cannot be blank.","filter_failure":"Error in filtering resoruces","edit_success":"Saved Changes","grades":"Grades","subjects":"Subjects","all_grades":"All Grades","all_subjects":"All Subjects","select_grades":"Select Grades","select_subjects":"Select Subjects","all_types":"All Types","all_sources":"All Sources","open_link":"Open Link","open_file":"Open File","web":"Web","type":"Type"},"link_resources":{"link_not_valid":"is not a valid web link.","link_blank_error":"cannot be blank."},"google_drive":{"link":"Google Drive","open_folder":"Open Google Drive Folder","remove":"Remove Google Drive","remove_confirmation":"Removing Google Drive access. This will not delete your files. Are you sure?","add_drive":"Add Google Drive","removed":"Removed Google Drive Account","remove_invalid":"Delete your own Google Account!","success_sync":"Synced with Google Drive","denied_oauth":"You denied TeacherMaps access to Google Drive","already_added":"Google Drive already added"},"drop_box":{"link":"Dropbox","add":"Add Dropbox","remove":"Remove Dropbox","open_folder":"Open Dropbox Folder","remove_confirmation":"Removing Dropbox access. This will not delete your files. Are you sure?","found_existing_account":"Found existing Dropbox account","session_request_error":"There was an error requesting for DropbBox authentication","removed":"Removed Dropbox Account","remove_invalid":"Delete your own Dropbox Account!","success_sync":"Synced with Dropbox Acccount","denied_oauth":"You denied TeacherMaps access to Dropbox"},"welcome_email":{"subject":"Welcome to TeacherMaps!","title":"Let's get started, %{name}","content_textonly":"Activate your account with the link below:","content":"%{activation_link} to active your account.","activation_link":"Click here"},"confirmation":{"success":"Thanks! We confirmed your email address."},"reset_password":{"subject":"Forgot your password?","content_textonly":"Click the link below to change your password:","content":"<p>We received a password reset request for your TeacherMaps account.</p>\n<p>%{action} to change your password.</p>\n","action":"Click here","new_password":"Enter a new password","submit":"Reset password","email":"What's your email address?","error":"Oops, that didn't work. Let's try again.","email_sent":"Check your email inbox to confirm your identity and reset your password","title":"Reset your password","link":"Forgot your password?"}}};
/*
